...
namespace CMC.Infrastructure.Migrations
{
    ...
    [Migration("20250919235300_Add2FAFields")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CMC.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Notifications", null, t =>
                        {
                            t.HasCheckConstraint("CK_Notifications_Severity", "\"Severity\" IN ('notice','success','error')");

                            t.HasCheckConstraint("CK_Notifications_Status", "\"Status\" IN ('unread','read')");
                        });
                });
