...
public sealed class BasicEmailTemplateRenderer : IEmailTemplateRenderer
{
    public Task<(string Subject, string Html, string? Text)> RenderEmailAsync(string subject, string text, object links)
    {
                ...
                var html = new StringBuilder()
                    ...
                    .Append("<p style=\"font-family: Helvetica, sans-serif; font-size: 20px; font-weight: bold; margin: 0; margin-bottom: 16px;\">" + subject + "</p>")
                    .Append("<p style=\"font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;\">" + text + "</p>")
                    ...
                    .Append("<tbody>")
                    .Append("<tr>")
                    .Append("<td style=\"font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; border-radius: 4px; text-align: center; background-color: #00609c;\" valign=\"top\" align=\"center\" bgcolor=\"#00609c\"> <a href=\"http://htmlemail.io\" target=\"_blank\" style=\"border: solid 2px #00609c; border-radius: 4px; box-sizing: border-box; cursor: pointer; display: inline-block; font-size: 16px; font-weight: bold; margin: 0; padding: 12px 24px; text-decoration: none; text-transform: capitalize; background-color: #00609c; border-color: #00609c; color: #ffffff;\">Call To Action</a> </td>")
                    .Append("</tr>")
                    .Append("</tbody>")
                    .Append("</table>")
                    .Append("</td>")
                    ...
                    .Append("<span class=\"apple-link\" style=\"color: #9a9ea6; font-size: 16px; text-align: center;\">Audicius : Alexander Welsch</span>")
                    .Append("<br>Auf dem Daubmann 6, 75045 Walzbachtal")
                    .Append("</td>")
                    .Append("</tr>")
                    .Append("<tr>")
