...
public sealed class BasicEmailTemplateRenderer : IEmailTemplateRenderer
{
        ...
        string? baseUrl = null)
    {
        ...
        var html = new StringBuilder()
            ...
            .Append("<span style=\"font-family: Helvetica, sans-serif; font-size: 20px; font-weight: bold; margin: 0; margin-bottom: 16px;\"><img width=\"150px\" src=\"https://audicius.de/hubfs/Logo_250px.png\"/></span>")
            ...
            .Append("<span class=\"apple-link\" style=\"color: #9a9ea6; font-size: 16px; text-align: center;\">Audicius : Alexander Welsch</span><br>Auf dem Daubmann 6, 75045 Walzbachtal")
            .Append("</td></tr><tr>")
            ...
            .Append("Automatische E-Mail von cmc.audicius.de")
            .Append("</td></tr></table>")
            .Append("</div></div>")
